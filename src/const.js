...
const STATE = {
  ESCAPED: 0, RANGE: 1, CHOICE: 2, GROUP_ONE: 3, GROUP_ANY: 4, GROUP_MANY: 5, GROUP_OPT: 6, GROUP_NOT: 7
};
...
const TOKEN_TO_RE = {
  ...
  [TOKEN.RANGE_NEGATE]: nums('^'), [TOKEN.CHOICE_START]: nums('('),
  [TOKEN.CHOICE_SEP]: nums('|'), [TOKEN.CHOICE_END]: nums(')'),
  [TOKEN.RANGE_START]: nums('['), [TOKEN.RANGE_SEP]: nums('-'),
  [TOKEN.RANGE_END]: nums(']'),
